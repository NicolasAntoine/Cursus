...
public class MatrixTest {
    ...
    public void test1() {
        ...
        Matrix mq = m.deleteColumn(3);
        Assert.assertEquals(5,mq.get(1,1));
        Assert.assertEquals(10,mq.get(2,2));
        ...
        Matrix mppp = mpp.deleteRow(0);
        Assert.assertEquals(8,mppp.get(0,0));

        Matrix mpppp = mpp.deleteRow(1);
        Assert.assertEquals(0,mpppp.get(0,0));
