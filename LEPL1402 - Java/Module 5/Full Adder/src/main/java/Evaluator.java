...
public class Evaluator {
    ...
    public Map<String, Boolean> evaluate_circuit(Boolean a, Boolean b, Boolean carry_in) {
        ...
        answer.put("SUM", xor_gate().apply(xor_gate().apply(a,b), carry_in));
        answer.put("carry_out", or_gate().apply(and_gate().apply(carry_in, xor_gate().apply(a,b)), and_gate().apply(a,b)));
        return answer;
    }
